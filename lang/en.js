window.WMSkyRegisterLocale('en', {
  ...
  messages: {
    ...
    eggHelpLead: 'A few simple constraints make egg missions much more reliable.',
    eggHelpItem1: 'Unlock Labyrinth Cave first through the dedicated mission or Wonder Mail code that opens the dungeon.',
    eggHelpItem2: 'Do egg missions one at a time: finish it and collect the egg before generating another one.',
    eggHelpItem3: 'Avoid keeping a Gabite Scale in your bag before using the code.',
    eggHelpItem4: 'Do not leave another egg in storage/daycare; some pre-existing states can break the exploit.',
    eggHelpLink: 'Open the Japanese page for more details',
